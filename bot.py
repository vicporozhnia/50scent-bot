...
async def on_startup(app):
    if os.path.exists(RESTART_NOTIFY_FILE):
        ...
        onboarding = (
            "✅ Бот перезапущено\\!\n\n"
            "Ось що я вмію:\n\n"
            "👗 *Мої аромати* — твій особистий гардероб\\. Додавай парфуми вручну або з каталогу, переглядай і видаляй\\.\n\n"
            "🔍 *Пошук* — знаходь аромати в каталозі за назвою, брендом або нотою\\. Додавай у гардероб або вішліст прямо з результатів\\.\n\n"
            "💝 *Вішліст* — зберігай аромати, які хочеш придбати\\. Переміщуй до гардеробу одним натисканням\\.\n\n"
